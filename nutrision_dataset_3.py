# -*- coding: utf-8 -*-
"""Nutrision_dataset 3.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/19CjkLn9c9Izu85e1NMCUI6qIv6d_-YHW
"""

import sys
!{sys.executable} -m pip install streamlit joblib plotly
...
<div class="main-header">
    <h1 style="color: white; text-align: center;">🍽️ Food Calorie Predictor</h1>
...
if predict_button:
    if model is not None and scaler is not None:
        ...
        st.info(f"ℹ️ Selisih antara prediksi model dan perhitungan manual: **{diff:.0f} kkal** ({diff_percent:.1f}%)")
...
with st.expander("📋 Informasi Model Machine Learning", expanded=False):
    ...
    5. **protein_fat** - Interaksi protein × lemak
    6. **carb_age** - Interaksi karbohidrat × usia

    #### Feature Importance:
    - Lemak (fat): **52.3%** - Paling dominan
    - Karbohidrat (carbohydrate): **34.2%**
    - Interaksi protein×lemak: **9.7%**
    - Protein: **2.5%**
    - Lainnya: **1.3%**
...
<div style="text-align: center; padding: 1rem;">
    <p style="color: gray;">
        © 2024 Food Calorie Predictor | Dibangun dengan Streamlit & Machine Learning
    </p>
    <p style="color: gray; font-size: 0.8rem;">
        Aplikasi ini menggunakan model Random Forest dengan akurasi R² = 0.86
    </p>
</div>
""", unsafe_allow_html=True)